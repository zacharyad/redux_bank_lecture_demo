...
deposit5.onclick = function () {
  return store.dispatch(depositSomeMoney(5));
};
deposit25.onclick = function () {
  return store.dispatch(depositSomeMoney(25));
};
withdraw5.onclick = function () {
  return store.dispatch(takeSomeMoney(5));
};
withdraw25.onclick = function () {
  return store.dispatch(takeSomeMoney(25));
};
...
//Action Creatores
var depositSomeMoney = function depositSomeMoney(amount) {
  // return {
...
var takeSomeMoney = function takeSomeMoney(amount) {
  return {
    type: WITHDRAW,
    amount: amount
  };
...
var _objectSpread2 = __webpack_require__(3);
